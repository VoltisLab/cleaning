        ...
        >
          ...
          <motion.form
            ...
            onSubmit={async (e) => {
              ...
              const result = await saveEmailSubscription(email, 'Download CTA');
              if (result.success) {
            ...
            className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-12 max-w-md mx-auto"
          >
            <input
              type="email"
              name="email"
