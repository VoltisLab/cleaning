...
interface LoginFormProps {
  ...
  setCurrentForm: (form: 'signup' | 'login' | 'createPassword' | 'forgotPassword' | 'verifyEmail') => void;
...
const LoginForm: React.FC<LoginFormProps> = ({
      ...
      <div className="flex items-center justify-between">
        <label className="flex items-center">
          <input
            ...
            onChange={handleInputChange}
            className="w-4 h-4 cursor-pointer text-blue-500 border-gray-300 rounded focus:ring-blue-500"
          />
  ...
  <hr className="flex-grow border-t border-gray-300" />
      ...
      <button
        ...
        className="w-full py-3 cursor-pointer border border-gray-300 rounded-full font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center gap-3"
      >
