  ...
  const renderLoginForm = () => (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full py-3 border border-gray-300 rounded-full font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center gap-3"
      >
